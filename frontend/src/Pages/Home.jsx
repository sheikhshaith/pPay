      ...
      <div className="max-w-6xl mx-auto mb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ">
          ...
          <div className="flex flex-col items-start md:items-end">
            ...
            <button className="bg-[#CF992D] hover:bg-[#CF992D] text-black px-6 py-3 rounded-full font-medium flex items-center gap-2 transition-all duration-300 hover:gap-3 self-start md:self-start">
              Learn More
